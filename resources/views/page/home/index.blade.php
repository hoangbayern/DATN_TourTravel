    ...
    <div class="hero-wrap js-fullheight" style="background-image: url({{ asset('page/images/travel_taybac.jpg') }});">
        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
                ...
                <a href="https://www.youtube.com/watch?v=Sxhfof7Y8Gw" class="icon-video popup-vimeo d-flex align-items-center justify-content-center mb-4">
                            ...
                            @foreach($locations as $location)
                                <div class="item">
                                    <div class="project-destination">
                                        <a href="{{ route('location', $location->id) }}" class="img" style="background-image: url({{ $location->l_image ? asset(pare_url_file($location->l_image)) :  asset('page/images/place-1.jpg') }});">
                                            <div class="text">
