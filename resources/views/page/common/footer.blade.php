        ...
        <div class="row mb-5">
            <div class="col-md pt-5">
                <div class="ftco-footer-widget pt-md-5 mb-4">
                    ...
                    <p>Website Happy Travel cho phép đặt các tour du lịch trong vào ngoài nước.</p>
            ...
            <div class="col-md pt-5 border-left">
                <div class="ftco-footer-widget pt-md-5 mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon fa fa-map-marker"></span><span class="text"> Duy Tien, Ha Nam</span></li>
                            <li><a href="#"><span class="icon fa fa-phone"></span><span class="text">0987082683</span></a></li>
                            <li><a href="#"><span class="icon fa fa-paper-plane"></span><span class="text">hoangdm2002@gmail.com</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
