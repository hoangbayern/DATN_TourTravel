...
<div class="container">
    <div class="header">
        <h4>Cảm ơn quý khách đã sử dụng dịch vụ của chúng tôi,<br>
            Booking của quý khách đã được thanh toán thành công</h4>
    </div>
    <div class="content">
        <h2>Phiếu xác nhận Thanh toán: <b>ĐÃ THANH TOÁN</b></h2>
        ...
        <div class="highlight">
            ...
            <p>Đã thanh toán: <b class="important">{{ number_format($totalPrice, 0, ',', '.') }} vnd</b></p>
